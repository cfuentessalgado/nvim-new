      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          map("K", vim.lsp.buf.hover, "Hover Documentation")
					...
					-- Format using conform (with LSP fallback)
		...
		vim.diagnostic.config({
			...
			-- Underline errors and warnings (not just errors)
			underline = true,
			...
			-- Disable virtual text by default (use <leader>e to see in float, <leader>td to toggle)
			virtual_text = false,
		})
